...
int main() {
    ...
    // vector<int> arr = {1, 2, 3, 4, 4, 3};                        Just practicing set...Nothing to do with the core logic.
    // cout << set<int>(arr.begin(), arr.end()).size() << endl;
    cout << "OK" << endl;
    return 0;
}
